...
void simulate() {
    ...
    while(simulating) {
	    ...
	    //std::cout<<"Main Force completed "<<f.sum()<<std::endl;
            //Interaction spring
	    ...
	    //std::cout<<"Main Stiffness completed "<<K.sum()<<std::endl;
            K = P*K*P.transpose();
        };
...
bool draw(igl::opengl::glfw::Viewer & viewer) {
	...
	//std::cout<<"Restart the PE KE. "<<PE<<" "<<KE<<std::endl;
        ...
        //std::cout<<"Finished Gravity & KE: "<< PE << " "<<KE <<std::endl;
        ...
        //std::cout<<"Finished Energy: " <<PE<<std::endl;
